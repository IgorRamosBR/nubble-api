...
let ShowPostCommentService = class ShowPostCommentService {
    ...
    run(commentId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield this.postCommentRepository.show(commentId);
                if (!comment)
...
ShowPostCommentService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('PostCommentRepository')),
    __metadata("design:paramtypes", [Object])
], ShowPostCommentService);
exports.ShowPostCommentService = ShowPostCommentService;
//# sourceMappingURL=ShowPostCommentService.js.map