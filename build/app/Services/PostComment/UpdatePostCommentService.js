...
exports.UpdatePostCommentService = void 0;
const tsyringe_1 = require("tsyringe");
const NotFoundException_1 = __importDefault(global[Symbol.for('ioc.use')]("App/Shared/Exceptions/NotFoundException"));
let UpdatePostCommentService = class UpdatePostCommentService {
    constructor(postCommentRepository) {
        this.postCommentRepository = postCommentRepository;
    }
    run(commentData, commentId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield this.postCommentRepository.findBy('id', commentId);
...
UpdatePostCommentService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('PostCommentRepository')),
    __metadata("design:paramtypes", [Object])
], UpdatePostCommentService);
exports.UpdatePostCommentService = UpdatePostCommentService;
//# sourceMappingURL=UpdatePostCommentService.js.map