...
Server_1.default.middleware.registerNamed({
    auth: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Shared/Middleware/Auth'))),
    refreshToken: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Shared/Middleware/RefreshTokenMiddleware'))),
});
