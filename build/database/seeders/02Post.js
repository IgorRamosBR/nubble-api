...
class PostSeeder extends Seeder_1.default {
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Post_1.default.createMany([
                {
                    user_id: 1,
                    text: 'Bom dia!',
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ minute: 40 }),
                },
                {
                    user_id: 3,
                    ...
                    created_at: luxon_1.DateTime.now().minus({ hour: 1, minute: 20 }),
                },
                {
                    user_id: 4,
                    ...
                    created_at: luxon_1.DateTime.now().minus({ hour: 3, minute: 30 }),
                },
                {
                    user_id: 5,
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ hour: 3 }),
                },
                {
                    user_id: 7,
                    ...
                    created_at: luxon_1.DateTime.now().minus({ hour: 4 }),
                },
                {
                    user_id: 8,
                    ...
                    created_at: luxon_1.DateTime.now().minus({ hour: 8 }),
                },
                {
                    user_id: 9,
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ days: 1, hour: 1 }),
                },
                {
                    user_id: 1,
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ days: 1, hour: 1, minutes: 45 }),
                },
                {
                    user_id: 9,
                    text: 'A noite me traz paz',
                    imageUrl: 'https://nubble-development.s3.sa-east-1.amazonaws.com/backend-integration/post15.jpg',
                    created_at: luxon_1.DateTime.now().minus({ days: 1, hour: 2, minutes: 30 }),
                },
                {
                    user_id: 3,
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ days: 2, minutes: 23 }),
                },
                {
                    user_id: 8,
                    ...
                    created_at: luxon_1.DateTime.now().minus({ days: 2, minutes: 30 }),
                },
                {
                    user_id: 9,
                ...
                },
                {
                    ...
                    created_at: luxon_1.DateTime.now().minus({ weeks: 1 }),
                },
                {
                    user_id: 7,
                    text: 'Good morning!',
                    imageUrl: 'https://nubble-development.s3.sa-east-1.amazonaws.com/backend-integration/post24.jpg',
                    created_at: luxon_1.DateTime.now().minus({ weeks: 1, hour: 4 }),
                },
            ]);
        });
    }
...
//# sourceMappingURL=02Post.js.map